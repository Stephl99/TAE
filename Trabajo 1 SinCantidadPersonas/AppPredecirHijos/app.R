    ...
    sidebarLayout(
        ...
        mainPanel(
            ...
            tags$div(class = "links", checked = NA,
                     ...
                     tags$a(href = "https://rpubs.com/StephanyL/790058", "Click aquí para ir al reporte técnico en RPubs", style="font-size:15px"),
                     br(),
                     br(),
...
server <- function(input, output) {
    ...
    output$description <- renderText({
        "Por favor proporcione los datos que se le piden en el formulario, 
        con base en ellos se predece la cantidad de hijos que habita en la vivienda."
    })
    observeEvent(input$predecir_hijos, {
        ...
        output$predicc <- renderText({
            ...
            prediccion <- as.integer(predRF(evaluables))
        })
    })
    #Autores
